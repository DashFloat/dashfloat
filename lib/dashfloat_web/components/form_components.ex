defmodule DashFloatWeb.Components.FormComponents do
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-primary-600 hover:bg-primary-700 py-3 px-2.5",
        "focus:ring-4 focus:outline-none focus:ring-primary-300 text-sm font-medium text-center text-white",
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    ~H"""
    <div phx-feedback-for={@name} class="flex items-center h-5">
      ...
      <div class="ml-3 text-sm">
        <label for={@id} class="text-gray-500 dark:text-gray-300"><%= @label %></label>
      </div>
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          ...
          @errors == [] && "border-gray-300 focus:border-primary-600",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
      />
